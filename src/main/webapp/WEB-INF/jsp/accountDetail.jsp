...
<head>
    ...
    <h1 class="m-5" style="font-family: 'Pacifico', cursive; color: #FF5630FF; font-size: 35px; text-align: center">Welcome to your account page !</h1>
        ...
        <div class="col-sm-4 col-xl-4 m-1">
            ...
            <div class="card mt-2" style="border-radius: 15px;">
                <div class="card-body text-center">
                    ...
                    <button type="button" class="btn" style="background-color: #FF5630FF; color:white" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                        Edit my account
                    </button>
