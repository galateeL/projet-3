    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2" style="font-family: 'Pacifico', cursive; color: #05516b; font-size: 30px; text-align: center">Edit contact</h5>
            ...
            <div class="modal-body">
                <form action="${pageContext.request.contextPath}/contacts/edit/${contact.id}" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn" style="background-color: #a8eaa8; color:white">Confirm
                        </button>
                    </div>
                </form>
            </div>
